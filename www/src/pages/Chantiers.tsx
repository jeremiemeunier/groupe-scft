...
const PageChantier = () => {
  return (
    <div className="teaui grid rgs-0 mt120">
      ...
      <div className="teaui grid background bg-nude mt40">
      ...
      <div className="teaui grid background bg-ceruleen">
        <div className="teaui grid tc-2 format-page sl pt80 ms-pt80 xs-pt80 pb80 ms-pb80 xs-pb80">
          <h2 className="teaui pa0 ms-pa0 xs-pa0 ma0 ms-ma0 xs-ma0 text fs-72">
      ...
      <div className="teaui grid background bg-cobalt-reverse">
        <div className="teaui grid tc-2 format-page sl pt80 ms-pt80 xs-pt80 pb80 ms-pb80 xs-pb80">
          <h2 className="teaui pa0 ms-pa0 xs-pa0 ma0 ms-ma0 xs-ma0 text fs-72">
          ...
          <div className="teaui grid pl40">
            <p>
              ...
              sans une ligne directe pour transporter les gens et les matériaux
              ! Ce projet, c’est un peu comme relier deux bouts d’un puzzle
              qu’on avait oubliés. Plus pratique, plus rapide… enfin, en
              théorie.
            </p>
            <Link
              to={""}
